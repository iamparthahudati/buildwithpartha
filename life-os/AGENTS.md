...
- Read `docs/31-PRIVACY-DATA-LIFECYCLE.md` before adding or changing collected/transmitted data, providers, retention, logs, browser storage, email, export/deletion, attachments or AI.
