...
| LOS-1004 | Model and implement Weekly Plan API | Week/capacity/outcomes/items/review status with draft/finalize/update, task/day allocation, conflict summary and historical snapshot. Respect week start/timezone. | LOS-0803, LOS-0902 | M | Done |
...
| LOS-1009 | Model review records and snapshots | Daily/weekly/monthly review schema, answers, draft/final state, snapshot metrics, local period keys/version. Missing data and repeated finalize handled. | LOS-0216, LOS-0108 | M | Done |
| LOS-1010 | Implement review APIs | Get prompts/metrics, save draft, finalize, reopen policy, list history. Snapshot is transactional, user-scoped, timezone-correct and stable after source changes. | LOS-1009 | M | Done |
