...
| LOS-1211 | Build habit components | HabitRow/Card, entry control, streak/consistency, calendar heatmap with table alternative, form, reminder, pause/archive and all states. | LOS-0429, LOS-0434 | M | Done |
| LOS-1212 | Compose and integrate Habits | Today/list/detail/history/statistics with optimistic safe entry rollback, URL dates, timezone change and responsive/a11y. | LOS-1209–LOS-1211 | L | Done |
| LOS-1213 | Add Today capture/habit integration | Quick Add/Today widgets use shared note/brain/habit services, show accurate queued/saved state and precise invalidation. | LOS-0604, LOS-1203, LOS-1207, LOS-1212 | M | Done |
| LOS-1214 | Run knowledge/habits gate | Notes autosave/conflict, brain conversion idempotency, habit/streak/timezone, ownership, offline labeling, sanitization, a11y and large data pass. | LOS-1201–LOS-1213 | S | Backlog |
