...
final class PackageBoundaryRules {
  ...
  static ArchRule approvedTopLevelPackages() {
    ...
    return classes()
        ...
        .because(
            "backend code must stay in the application root, common, config, "
  ...
  static ArchRule domainIsolation() {
    ...
    for (String domain : DOMAIN_PACKAGES) {
      ...
      String[] otherDomainPackages =
          DOMAIN_PACKAGES.stream()
      ...
      ArchRule rule =
          noClasses()
              ...
              .because(
                  domain
                      + " must collaborate through domain-neutral contracts "
  ...
  static ArchRule commonIsDomainNeutral() {
    return noClasses()
        ...
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage(concat(domainPackages(), new String[] {BASE_PACKAGE + ".config.."}))
        .because(
            "common is the stable inward dependency and must not point to domains "
                + "or configuration");
  }
    ...
    for (String domain : DOMAIN_PACKAGES) {
      ...
      ArchRule rule =
          classes()
              ...
              .because(
                  domain
                      + " may use only api, application, domain, "
  ...
  static ArchRule layerDirection() {
    ArchRule domainRule =
        noClasses()
            ...
            .because(
                "domain code must remain independent from delivery, orchestration, "
                    + "Spring, and JPA")
            .allowEmptyShould(true);

    ArchRule applicationRule =
        noClasses()
            .that()
            ...
            .dependOnClassesThat()
            .resideInAnyPackage(
                concat(domainLayerPackages("api"), domainLayerPackages("infrastructure")))
    ...
    ArchRule apiRule =
        noClasses()
            ...
            .because(
                "API adapters must reach persistence and providers through "
                    + "application contracts")
            .allowEmptyShould(true);

    ArchRule infrastructureRule =
        noClasses()
            .that()
            .resideInAnyPackage(domainLayerPackages("infrastructure"))
            .should()
  ...
  private static String[] domainPackages() {
    return DOMAIN_PACKAGES.stream().map(PackageBoundaryRules::domainPackage).toArray(String[]::new);
  }
