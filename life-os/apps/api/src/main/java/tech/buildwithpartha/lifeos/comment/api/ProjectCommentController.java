...
/** Authenticated nested Project Comment CRUD API. */
@RestController
...
public class ProjectCommentController {
  ...
  public ProjectCommentController(CommentService service) {
    this.service = service;
  }

  @Operation(operationId = "listProjectComments", summary = "List Project comments")
  ...
  public PageResponse<CommentResponse> list(
    ...
    PageResponse<Comment> result =
        service.list(userId, CommentParentType.PROJECT, projectId, page, size);
  ...
  @Operation(operationId = "createProjectComment", summary = "Add a Project comment")
  ...
  public ResponseEntity<CommentResponse> create(
    ...
    URI location =
        URI.create("/life-os/api/v1/projects/" + projectId + "/comments/" + created.id());
    return ResponseEntity.created(location).body(CommentResponse.fromDomain(created));
  }

  @Operation(operationId = "getProjectComment", summary = "Get a Project comment")
  ...
  public CommentResponse get(
    ...
    return CommentResponse.fromDomain(
        service.get(userId, CommentParentType.PROJECT, projectId, commentId));
  }

  @Operation(operationId = "updateProjectComment", summary = "Edit a Project comment")
  @SecurityRequirement(name = "csrfToken")
  ...
  @Operation(operationId = "deleteProjectComment", summary = "Delete a Project comment")
  @SecurityRequirement(name = "csrfToken")
  ...
  public ResponseEntity<Void> delete(
    ...
    service.delete(
        ...
        projectId,
        commentId,
        CommentVersionHeaders.parse(version));
